=============================
//17:31:00
TO MAKE THE FRONTEND PROJECT:
1. do "yarn add moralis react-moralis web3uikit"
2. create a "constants" folder where you put your abi and contract address
3. do "hh node" in your smart contract to be able to connect to it
4. 
